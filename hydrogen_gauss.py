...
# deriv(deriv(xi)) + [ 2 m (E - V) - l (l+1)/r^2 ] xi = 0
# xi = sum_i c_i 1/sqrt(4 pi s_i^2) exp(-r^2/(2 s_i^2)) = sum_i c_i f_i
# deriv(xi) = - sum_i c_i s_i^2/sqrt(4 pi s_i^2) r exp(-r^2/(2 s_i^2))
# deriv(deriv(xi)) = sum_i c_i s_i^2/sqrt(4 pi s_i^2) (s_i^2 r - 1) exp(-r^2/(2 s_i^2))
#                  = sum_i c_i f_i (s_i^2 (s_i^2 r - 1) )
# sum_i c_i [ s_i^2 (s_i^2 r - 1) + 2 m (E - V) - l (l+1)/r^2 ] f_i = 0
# multiply by xi and integrate in r
# int sum_ij c_i c_j f_i f_j [ s_i^2 ( s_i^2 r - 1) ] dr = sum_ij c_i c_j {
# int f_i f_j dr = int 1/(4 pi s_i^2 s_j^2) exp(-r^2/(1/(2s_i^2) + 1/(2s_j^2))) dr = 
# int f_i f_j r dr = int r 1/(4 pi s_i^2 s_j^2) exp(-r^2/(1/(2s_i^2) + 1/(2s_j^2))) dr = 
